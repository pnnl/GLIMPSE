         ...
         <DialogContent sx={{ maxWidth: "72rem", padding: "0 2rem" }}>
            ...
            <div className="description">
               <p>
                  ...
                  grid models. The tool can be used to search and highlight power grid model
                  objects. GLIMPSE also aims to support a variety of different network
