...
const Nav = ({
   ...
   const sortedEdgeIDs = useMemo(() => {
      ...
      return graphData.current.edges.get().sort((a, b) => -b.type.localeCompare(a.type));
   }, [showSearch, graphData.current]); // Depends on showSearch and the edges collection itself
   ...
   const sortedNodeIDs = useMemo(() => {
      ...
      return graphData.current.nodes.get().sort((a, b) => -b.type.localeCompare(a.type));
   }, [showSearch, graphData.current]); // Depends on showSearch and the nodes collection itself
